...
class DomesticTourImageAdmin(admin.ModelAdmin):
    list_display = ('tour', 'image_preview')
...
class InternationalTourImageAdmin(admin.ModelAdmin):
    list_display = ('tour', 'image_preview')
...
class DomesticTourAdmin(admin.ModelAdmin):
    ...
    readonly_fields = ('slug',)  # Slug alanını salt okunur yapıyoruz
...
admin.site.register(DomesticTourImage, DomesticTourImageAdmin)
admin.site.register(InternationalTourImage, InternationalTourImageAdmin)